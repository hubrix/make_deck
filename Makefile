...
.PHONY: help check build open bootstrap-macos make_deck

help:
	@echo "Targets:"
	@echo "  check      - Verify dependencies (pandoc + TeX engine)"
	@echo "  build      - Generate presentation.pdf with enhanced styling"
...
open:
	...
	else echo "No PDF found. Run 'make build' first."; exit 1; fi

bootstrap-macos:
	bash scripts/bootstrap-macos.sh

make_deck: pandoc/templates/simple_beamer.latex make_deck.template.sh build_make_deck.py
